...
llm_kwargs = chat_kwargs["llm_kwargs"]
llm_kwargs.update(
    {"llm_model": "text-embedding-3-small", "embed_model": "text-embedding-3-small"}
)
...
rag_worker = LlamaIndexRagWorker(
    "good-man-user", llm_kwargs, checkpoint_dir="./longlong_vector_store"
)
