...
def define_gui_floating_menu(
    ...
    with gr.Floating(
        ...
        width="40%",
        drag="top",
        elem_id="f_area_input_secondary",
            ...
            with gr.Row() as row:
                ...
                with gr.Column(scale=1, min_width=70):
                    ...
                    h.then(
                        ...
                        [web_cookie_cache],
                        None,
                        _js="""(web_cookie_cache)=>{localStorage.setItem("web_cookie_cache", web_cookie_cache);}""",
                    )
                    # clean up btn
                    h2 = basic_fn_clean.click(
                        assign_btn,
                        [
                            web_cookie_cache,
                            cookies,
