...
from toolbox import get_conf, get_log_folder, trimmed_format_exc, update_ui
...
class construct_html:
    ...
    def save_file(self, file_name):
        ...
        with open(
            "crazy_functions/pdf_fns/report_template.html", "r", encoding="utf8"
        ) as f:
