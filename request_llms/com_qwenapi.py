...
class QwenRequestInstance:
    ...
    def format_reasoning(self, reasoning_content: str, main_content: str):
        if reasoning_content:
            reasoning_content_paragraphs = "".join(
                [
    ...
    def generate(self, inputs, llm_kwargs, history, system_prompt):
        ...
        if model_name.startswith(model_prefix_to_remove):
            model_name = model_name[len(model_prefix_to_remove) :]
