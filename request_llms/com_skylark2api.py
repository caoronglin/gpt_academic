...
class YUNQUERequestInstance:
    ...
    def generate(self, inputs, llm_kwargs, history, system_prompt):
        ...
        YUNQUE_SECRET_KEY, YUNQUE_ACCESS_KEY, YUNQUE_MODEL = get_conf(
            "YUNQUE_SECRET_KEY", "YUNQUE_ACCESS_KEY", "YUNQUE_MODEL"
        )
        ...
        req = {
            ...
            "messages": self.generate_message_payload(
    ...
    def generate_message_payload(inputs, llm_kwargs, history, system_prompt):
        ...
        messages = [
            {"role": ChatRole.USER, "content": system_prompt},
