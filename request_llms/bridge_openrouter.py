...
def predict_no_ui_long_connection(
    ...
    while True:
        ...
        if len(chunk_decoded) == 0 or chunk_decoded.startswith(":"):
            continue
        ...
        while True:
            try:
                ...
                yield from update_ui(
                    chatbot=chatbot,
                    history=history,
                    msg="非OpenAI官方接口返回了错误:" + chunk.decode(),
                )  # 刷新界面
                return
            ...
            if chunk:
                try:
                    ...
                    if has_content:
                        ...
                        if chunkjson["choices"][0]["delta"]["content"] is None:
                            continue  # 一些垃圾第三方接口出现这样的错误，兼容一下吧
                        gpt_replying_buffer = (
                            gpt_replying_buffer
                            + chunkjson["choices"][0]["delta"]["content"]
                        )
